...
require '../controllers/mostrarDatosEditarAdminController.php';
...
<body class="py-3">
    <main class="container contenedor">
        <div class="p-3 rounded">
            ...
            <div class="row">
                <div class="col">
                    <form class="row g-3" method="POST" action="../controllers/editarAdminController.php" autocomplete="off">
                        <div class="col-md-8">
                        ...
                        <div class="col-md-8">
                            ...
                            <input type="text" id="email" name="email" class="form-control" value="<?php echo $resultado['email'];?>" readonly>
                        </div>
                        <div class="col-md-8">
                            <label for="clave" class="form-label">Clave</label>
                            <input type="password" id="clave" name="clave" class="form-control" value="<?php echo $resultado['clave'];?>" readonly>
                        </div>
                        <div class="col-md-8">
